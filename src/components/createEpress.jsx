...
const CreateEpress = () => {
    ...
    const [epressCall, setEpress] = useState("");
    ...
    const saveSearch = async (e) => {    //function to save the search
        ...
        console.log("From the set function: " + epressCall);
        const sourceType = "epress";
    ...
    const getExample = async (e) => {              //function to get the example results based on the search boolean
        ...
        const finalQuery = "https://www.epress.fi/api/search?limit=250&sort=date-desc&f=rss&au_id=10001&au_key=wvyZ9mU1zc612YWaSWgH&q=" + encodeURI(searchBoolean) + "&output=json";  //epress call

        console.log("this is the final query " + finalQuery);
        setEpress(finalQuery);    //saving the final api call for the search in the variable epressCall

        var epressCall = "https://www.epress.fi/api/search?limit=250&sort=date-desc&f=rss&au_id=10001&au_key=wvyZ9mU1zc612YWaSWgH&q=" + searchBoolean + "&output=json";
        //  console.log(epressCall);
